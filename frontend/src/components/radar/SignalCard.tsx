...
export default function SignalCard({ signal, onClick, className, isSelected }: Props) {
  const timeStr = formatDistanceToNow(new Date(signal.timestamp), { addSuffix: true });
    ...
    >
      <div className="flex justify-between items-start mb-3">
        <div className="flex flex-col">
          ...
          <span className="text-[#888888] text-xs uppercase tracking-wider">{typeDisplay}</span>
        </div>
